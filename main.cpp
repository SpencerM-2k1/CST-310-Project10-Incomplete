...
int main() {
    ...
    // Cube vertices (used for cubemapping)
    //  Adapted from LearnOpenGL's cubemapping lesson: https://learnopengl.com/Advanced-OpenGL/Cubemaps
    float cubeVertices[] = {
        // positions          // normals
    ...
    // cube VAO (need separate VAO and VBO from the checkerboard)
    ...
    //for (int i = 0; i < 2; i++)
    {
        ...
        glBindTexture(GL_TEXTURE_CUBE_MAP, cubemapTexture); //Project 10: Note the GL_TEXTURE_CUBE_MAP
